...
class _CourseInfoState extends State<CourseInfo> {
        ...
        children: [
          RichText(
            text: TextSpan(
              ...
              children: [
                const TextSpan(text: ' '),
                TextSpan(
                  text: widget.course.author.name,
          ...
          Row(
            children: [
              ...
              Text('last-updated-', style: Theme.of(context).textTheme.bodyLarge).tr(
                args: [AppService.getDate(widget.course.updatedAt ?? widget.course.createdAt)],
              ),
            ],
          ),
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 5),
              Text('language-', style: Theme.of(context).textTheme.bodyLarge).tr(args: [widget.course.courseMeta.language.toString()]),
            ],
          ),
          const SizedBox(height: 8),
          Row(
            children: [
              ...
              const SizedBox(width: 5),
              Text('duration-', style: Theme.of(context).textTheme.bodyLarge).tr(args: [widget.course.courseMeta.duration.toString()]),
            ],
          ),
          const SizedBox(height: 8),
          Row(
            children: [
              ...
              const SizedBox(width: 5),
              Text('count-lesson', style: Theme.of(context).textTheme.bodyLarge).tr(args: [widget.course.lessonsCount.toString()]),
            ],
          ),
        ],
      ),
  ...
  void _onTapAuthor(BuildContext context) async {
    final UserModel? author = await FirebaseService().getAuthorData(widget.course.author.id);
